...
Jika berminat hubungi: @${global.owner[0]} untuk order`, m);
      ...
      if (isROwner) {
        ...
        db.data.users[m.sender].premiumDate = "∞";
        db.data.users[m.sender].limit = "∞";
        ...
        message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
                contextInfo: {
                    ...
                    newsletterName: "Powered By manzxy🐉",
                        serverMessageId: -1
                    }, 
                    externalAdReply: {
                        title: action === "add"
                          ...
                          : "\n──────< ʟ ᴇ ᴀ ᴠ ɪ ɴ ɢ >──────\n",
                        body: action === "add"
                          ? `👋Welcome To ${nama} from ${gpname} at ${moment.tz("Asia/Jakarta").format("HH:mm:ss")}`
                          : `👋 Sayonara ${nama} leaving from ${gpname} at ${moment.tz("Asia/Jakarta").format("HH:mm:ss")}`,
                        thumbnailUrl: pp,
...
global.dfail = (type, m, conn) => {
    let msg = {
      ...
      private:  `Perintah ini hanya dapat digunakan dalam private chat`,
      admin: `Perintah ini hanya dapat digunakan oleh admin group`,
      botAdmin: `Jadikan bot sebagai admin grup agar bot dapat mengakses grup.`,
      block: `Fitur Ini Di Block Oleh Owner`,
      unreg: `Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar manzxy.18*`,
