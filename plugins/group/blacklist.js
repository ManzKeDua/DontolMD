    ...
    switch (command) {
        case 'larang':
            ...
            try {
                ...
                await conn.reply(m.chat, `Sukses menambahkan @${who.split(`@`)[0]} ke *Larangan*`, m, {
                    contextInfo: {
                        mentionedJid: [who]
                    }
                });
        ...
        case 'unlarang':
            ...
            try {
                ...
                db.data.chats[m.chat].blacklist = bl;
                await conn.reply(m.chat, `Sukses menghapus Nomor: @${who.split(`@`)[0]} dari *Larangan*`, m, {
                    contextInfo: {
                        mentionedJid: [who]
                    }
                });
